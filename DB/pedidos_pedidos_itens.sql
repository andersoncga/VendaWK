...
CREATE TABLE `pedidos_itens` (
  ...
  KEY `pedidos_itens_numero_pedido_IDX` (`numero_pedido`) USING BTREE,
  CONSTRAINT `pedidos_itens_FK` FOREIGN KEY (`numero_pedido`) REFERENCES `pedidos` (`numero_pedido`)
...
INSERT INTO `pedidos_itens` VALUES (15,8,15,1,15),(16,8,2,3,2.75),(17,7,20,1,20),(18,9,2,1,2),(19,11,5,1,5);
...
-- Dump completed on 2022-02-03 10:26:33
