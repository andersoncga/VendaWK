...
begin
  ...
  case FTypeAlert of
    taSuccess: begin
                 ...
                 img_icone.Picture.LoadFromFile(LPath+'Images\Icones\success.png');
               end;
    taError:   begin
                 pnl_body.Color   :=  $003D4CE8;
                 pnl_image.Color  :=  $003D4CE8;
                 img_icone.Picture.LoadFromFile(LPath+'Images\Icones\error.png');
               end;
    taInfo:    begin
                 pnl_body.Color   :=  $00DB9835;
                 pnl_image.Color  :=  $00DB9835;
                 img_icone.Picture.LoadFromFile(LPath+'Images\Icones\info.png');
               end;
    taWarning: begin
                 pnl_body.Color   :=  $00119CF3;
                 pnl_image.Color  :=  $00119CF3;
                 img_icone.Picture.LoadFromFile(LPath+'Images\Icones\warning.png');
               end;
  end;
end;
